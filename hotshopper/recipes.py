...
class PotatoSoup(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Carrot(kilogram, 0.5),
                            Onion(piece, 1),
...
class ParsleyRootCurry(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [LowStarchPotatoe(gram, 750),
                            ChiliPepper(piece, 1),
                            Carrot(gram, 250),
                            Onion(piece, 5),
                            Ginger(piece, 1),
...
class SwedeStew(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Onion(piece, 1),
                            Swede(gram, 500),
...
class SalsaNoodles(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [SpaghettiNoodles(gram, 400),
                            Lemon(piece, 1),
...
class OrientalSproutPan(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [PrimarilyWaxyPotato(kilogram, 1),
                            Sprout(gram, 750),
                            Carrot(gram, 150),
                            Onion(piece, 1),
                            Ginger(piece, 1),
...
class OvenTomatoes(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Caraway(piece, 1),
...
class Pichelsteiner(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Carrot(gram, 400),
                            CeleryRoot(gram, 250),
...
class ChicoryWithHam(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Chicory(piece, 4),
                            Orange(piece, 2),
...
class PepperSalad(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Cabanossi(gram, 250),
                            PepperRed(piece, 6),
                            Zucchini(piece, 2),
                            Buckwheat(gram, 50),
                            ]
...
class NoodlePanWithPumpkinAndTomatos(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Macaroni(gram, 400),
                            Onion(piece, 1),
...
class RicePan(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [RiceBasmati(gram, 280),
                            ChiliPepper(piece, 2),
                            Ginger(piece, 2),
                            PepperRed(piece, 4),
...
class PaprikaCreamCauliflower(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [CauliflowerFrozen(gram, 1000),
                            Onion(piece, 2),
                            ParsleyFrozen(piece, 1),
...
class AsparagusWithSpinachCheeseSauce(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Asparagus(gram, 1000),
                            Onion(piece, 2),
...
class ChickenFajitas(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [ChiliPepper(piece, 2),
                            Lime(piece, 2),
                            Garlic(piece, 2),
...
class SproutBolognese(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [StarchyPotato(gram, 800),
                            Onion(piece, 2),
                            Carrot(gram, 200),
                            Sprout(gram, 600),
                            GroundMeat(gram, 400),
...
class HotDogs(Recipe):
    ...
    def __init__(self):
        super().__init__()
        self.name = "Hot Dogs"
        self.ingredients = [Baguette(piece, 2),
                            Wiener(piece, 8),
                            Pickles(piece, 1),
                            Onion(piece, 4)
                            ]
...
class RicePuddingRecipe(Recipe):
    ...
    def __init__(self):
        super().__init__()
        self.name = "Milchreis"
        self.ingredients = [RicePudding(gram, 250),
                            Milk(gram, 1000),
...
class SausageSalad(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [SausageStripes(gram, 400),
                            Pickles(piece, 1),
                            Onion(piece, 2),
                            Baguette(piece, 1)
                            ]
...
class VeggieRice(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [RiceBasmati(piece, 2),
                            PepperRed(piece, 1),
...
class ZucchiniTomatoPan(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Onion(piece, 2),
                            Garlic(piece, 2),
                            Zucchini(piece, 3),
...
class SaladAndMaultaschen(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Lettuce(piece, 1),
                            Tomato(piece, 2),
                            PepperRed(piece, 1),
                            Cucumber(piece, 1),
                            Onion(piece, 5),
...
class NoodlesWithPesto(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [PestoGenovese(piece, 1),
...
class ChiliMascarponeNoodles(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [NoodlesSpiral(gram, 400),
                            Mascarpone(gram, 250),
                            HamCooked(piece, 1),
                            Cream(piece, 1)
                            ]
...
class GyrosPita(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [PorkCuts(gram, 250),
                            Tomato(piece, 3),
                            Onion(piece, 2),
                            Tzatziki(piece, 1),
                            PitaBread(piece, 1)
...
class FishSticks(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [Fishsticks(piece, 1),
                            PeasFrozen(piece, 1),
...
class BakedPotato(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [StarchyPotato(gram, 1500),
                            SourCream(piece, 2),
...
class SandwichMaker(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [ToastbreadSandwich(piece, 1),
                            Tomato(piece, 3),
                            Salami(piece, 2),
...
class Lasagne(Recipe):
    ...
    def __init__(self):
        super().__init__()
        self.name = "Lasagne"
        self.ingredients = [MaggiFixLasagna(piece, 2),
...
class CroquettesWithVegetables(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [CroquettesFrozen(piece, 1),
                            PeasFrozen(piece, 1),
...
class PepperCreamSchnitzel(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [MaggiFixPepperCreamSchnitzel(piece, 2),
                            PepperRed(piece, 2),
                            Cream(piece, 2),
...
class Tortellini(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [TortelliniDried(piece, 2),
                            TomatoSauce(piece, 2),
                            Onion(piece, 2),
...
class Waffles(Recipe):
    ...
    def __init__(self):
        super().__init__()
        self.name = "Waffeln"
        self.ingredients = [WheatFlour(gram, 300),
...
class ToastHawaii(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [ToastbreadWheatSlice(piece, 10),
...
class CheeseNoodles(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [SpaetzleNoodles(piece, 1),
...
class SpaghettiWithTomatosauce(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [SpaghettiNoodles(gram, 500),
                            TomatoSauce(piece, 2),
                            Onion(piece, 2),
                            ParmesanCheese(piece, 1)
                            ]
...
class PepperStew(Recipe):
    ...
    def __init__(self):
        ...
        self.ingredients = [PepperRed(piece, 3),
