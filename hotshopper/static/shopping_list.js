...
function open_edit_shopping_list_screen() {
    window.location.href = "/shopping_list/edit";
}
...
//         placeholder.classList.add('placeholder_selection');
...
//     row.addEventListener("mousedown", mouseDownHandler);
// });
// export {swap, cloneTable, isAbove, mouseDownHandler,
